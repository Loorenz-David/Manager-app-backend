...
| 3 | Closeout: the frontend handoff (§8's six obligations), the production-time reply, and phase 2's seven carried repairs. | **NOT_STARTED** | 2026-08-19 | — | Plan at `plans/plan_3.md`, 8 criteria. Projection **waivable** — no new mechanism; the justification is written into §5 for the record. Review: one light round, the first time this project's MVP calibration condition is actually satisfied. |
