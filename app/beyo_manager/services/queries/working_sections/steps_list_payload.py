...
from beyo_manager.services.queries.utils.upholstery_grouping import load_upholstery_group_inventories
...
async def build_steps_list_payload(
    ...
    *,
    ...
    reassigned_step_ids = reassigned_step_ids or set()
    group_key_by_step_id = group_key_by_step_id or {}
    group_image_by_step_id = group_image_by_step_id or {}
    group_uph_id_by_step_id = group_uph_id_by_step_id or {}
