...
| 4 | Configuration services | `plans/phase_4_configuration_services.md` | ⚑ (rows 15–20) | NOT_STARTED | 2026-08-12 | coordinator | groups, chains, guarded deletes, config status; projection r0 prompt authored (`prompts/reviewer/2026-08-12_phase4_projection_r0.md`; forwards: N3 enum order, N7 persisted-rate arbiter, S4 request parse) |
