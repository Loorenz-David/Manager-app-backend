...
- **Current head (updated at phase-8 closeout, 2026-08-15):** `c1d2e3f4a5b6`
  ...
  **Suite baseline at phase-8B closeout (2026-08-15): 2184 / 23
  (byte-identical phase-1 list) / 1 deselected = 2207 selected (2208
  collected).** Prior baselines for history: phase-8 closeout 2138/23/1 =
