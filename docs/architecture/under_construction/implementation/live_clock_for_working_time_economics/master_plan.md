...
state: IN PROGRESS. Gate PASSED; phase 1 APPROVED (`d21fe9e`); **phase 2 APPROVED**
       (`efd6b99`, 2026-08-21, six rounds); **phase 3 PROMPT_READY (projection r0)**;
       phase 4 NOT_STARTED.
       Next: hand `prompts/reviewer/2026-08-21_phase3_projection_r0.md` to a projection
       session (REQUIRED — money/percent derivation, rule 6). Test-evidence policy
       (charter, 2026-08-21) is live from this prompt onward; phase 3 is its pilot.
