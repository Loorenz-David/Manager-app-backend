...
async def test_c11_c12_c20_c24_e2_and_e3_agree_and_keep_e2_shape(db_session):
    ...
    try:
        ...
        assert e2_row["allocation_method"] == ALLOCATION_METHOD == "static_proportional_section_v1"
        assert set(e2_row) == {"task_id", "status", "allowed_worker_minutes", "actual_worker_seconds", "remaining_worker_minutes", "allocation_method", "steps"}
        assert result_keys(e2_row["steps"][0]) == {"step_id", "working_section_id", "section_name_snapshot", "typical_worker_seconds", "allowance_seconds", "worked_seconds", "left_seconds", "share_state"}
