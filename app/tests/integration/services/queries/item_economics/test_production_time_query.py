...
async def test_c11_c12_c20_c24_e2_and_e3_agree_and_keep_e2_shape(db_session):
    ...
    try:
        ...
        assert set(e2_row) == {"task_id", "status", "allowed_worker_minutes", "actual_worker_seconds", "remaining_worker_minutes", "allocation_method", "pressure_ratio", "pressure_method", "typical_resolution", "projection_quantity", "steps"}
        assert result_keys(e2_row["steps"][0]) == {"step_id", "state", "working_section_id", "section_name_snapshot", "typical_worker_seconds", "typical_basis", "sample_count", "typical_unit_worker_seconds", "projected_typical_worker_seconds", "allowance_seconds", "worked_seconds", "left_seconds", "share_state", "pressure_share_seconds", "live_accrual_rate", "live_concurrency"}
