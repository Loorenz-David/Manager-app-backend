...
async def test_refresh_token_rejected_when_cookie_missing() -> None:
    ctx = ServiceContext(identity={}, incoming_data={}, session=None)  # type: ignore[arg-type]
...
async def test_refresh_token_returns_access_token_when_cookie_valid() -> None:
    ...
    ctx = ServiceContext(identity={}, incoming_data={"refresh_token": refresh}, session=None)  # type: ignore[arg-type]
