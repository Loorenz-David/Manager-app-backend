...
| 5 | Valuation surface | `plans/phase_5_valuation_surface.md` | ⚑ (rows 15,16 — valuation chain; 34) | NOT_STARTED | 2026-08-11 | planner | ItemValuation chain command + preview. Projection r0 prompt authored 2026-08-13 (`prompts/reviewer/2026-08-13_phase5_projection_r0.md`; folds §7C shipped signatures, N-d live re-measure, forward-notes block, head 5caae620088c, baseline 1927/23/1) |
