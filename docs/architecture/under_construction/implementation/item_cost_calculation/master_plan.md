...
| 7 | Evaluations | `plans/phase_7_evaluations.md` | ⚑ (rows 2,5,7,10,14,16,17,19,21–25) | NOT_STARTED | 2026-08-11 | planner | commit tx, projections, promotion, auto path, mirror. Projection r0 prompt authored 2026-08-14 (`prompts/reviewer/2026-08-14_phase7_projection_r0.md`; plan predates rounds 11-15 and phases 4-6 — axes: §7.2 one-transaction commit+mirror, R1-4 auto-commit never fails task creation, §7A.6 FOR SHARE counterparty (live-verified hazard), resolver consumption not re-derivation, N15 rederive-marker discipline, decidability) |
