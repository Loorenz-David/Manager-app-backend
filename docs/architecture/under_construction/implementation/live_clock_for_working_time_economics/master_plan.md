...
state: IN PROGRESS. Gate PASSED; phase 1 APPROVED (`d21fe9e`); phase 2 **PROJECTED**
       ...
       Next: hand `prompts/implementer/2026-08-20_phase2_implement_r1.md` to an
       implementer session.
