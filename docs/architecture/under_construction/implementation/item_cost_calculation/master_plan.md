...
- **Current head (updated at phase-6 closeout, 2026-08-14):** `be9dfe42a035`
  (phase 6's column drop; chain … → `5caae620088c` (4B) → `5420acc6a7b3`
  (data migration) → `be9dfe42a035`). Suite baseline at closeout: 2012 / 23
  (byte-identical phase-1 list) / 1 deselected = 2035 selected. Earlier head
  mentions in this section are historical records.
