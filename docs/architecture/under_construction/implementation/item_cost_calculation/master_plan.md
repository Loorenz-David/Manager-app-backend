...
| 6 | Legacy money migration & API bridge | `plans/phase_6_legacy_migration_api_bridge.md` | ⚑ (rows 31,32) | NOT_STARTED | 2026-08-11 | planner | journaled migrate-and-drop + reject-iff-non-null bridge. Projection r0 prompt authored 2026-08-14 (`prompts/reviewer/2026-08-14_phase6_projection_r0.md`; plan predates rounds 11-13 — axes: INV-V1/chain interaction, bulk created_at tie-breaker, live legacy-money measurement incl. the §10.2 refusal class, API-bridge greps re-run, enum ownership at the migration site, journal reversibility by state queries) |
