...
```
state: IN PROGRESS. Gate PASSED; phase 1 APPROVED (`d21fe9e`); phase 2 **REVIEWING**
       (fix r4 consumed; re-review r5 dispatched); phases 3–4 NOT_STARTED.
       Next: hand `prompts/reviewer/2026-08-20_phase2_rereview_r5.md` to a reviewer.
