...
- **Current head (updated at phase-8 closeout, 2026-08-15):** `c1d2e3f4a5b6`
  ...
  **Suite baseline at phase-8 closeout: 2138 / 23 (byte-identical phase-1
  list, sorted-diff verified by three independent sessions) / 1 deselected
  = 2161 selected (2162 collected).** Prior baseline for history: phase-7
  closeout 2076 / 23 / 1 = 2099 selected (reviewer-measured foreground, +39
