...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("tasks-list-tasks", "beyo_manager/services/queries/tasks/tasks.py", 466, serialize_item),
        ("tasks-get-task", "beyo_manager/services/queries/tasks/tasks.py", 780, serialize_item),
        ...
        ("pending-seat-tasks", "beyo_manager/services/queries/items/seat_tasks_pending_upholstery.py", 337, serialize_item),
