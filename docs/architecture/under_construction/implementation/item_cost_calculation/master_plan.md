...
| 3 | Canonical calculator | `plans/phase_3_canonical_calculator.md` | ⚑ (rows 1–14) | **IMPLEMENTED** | 2026-08-12 | Codex | pure calculator + C1–C9 unit proof; 54 focused tests, full suite 1738 passed / 23 known failures / 1 deselected (failure set baseline-identical); all named C2×5, C6, C7 FK-read, and C9×2 mutations reddened and reverted; checkpoint pending review |
