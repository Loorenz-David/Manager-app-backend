...
class PauseReasonWorkingSectionLink(IdentityMixin, Base):
    CLIENT_ID_PREFIX = "prsl"
    __tablename__ = "pause_reason_working_section_links"
    ...
    working_section_id: Mapped[str] = mapped_column(
        String(64),
        ForeignKey("working_sections.client_id", ondelete="RESTRICT"),
        nullable=False,
        index=True,
    )
