...
state: IN PROGRESS. Gate PASSED; phase 1 APPROVED (`d21fe9e`); phase 2
       **REVIEWING** (fix r2 consumed; review r3 dispatched — the phase's first
       review); phases 3–4 NOT_STARTED.
       Next: hand `prompts/reviewer/2026-08-20_phase2_review_r3.md` to a reviewer.
